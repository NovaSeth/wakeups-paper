=== REASONING ===
Iteration 1. Tested all 6 implementations. Bugs found and fixed: 32-only-end-expand; 38-correct; 126-v>1->v>2; 129-max->min; 132->2->>=2; 137-inverted.
...
=== NEW_STATE ===
All 6 done in iter 1.

=== CYCLE_NOTE ===
All 6 bugs identified and fixed in single iteration.